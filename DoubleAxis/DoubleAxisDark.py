...
mpl.rcParams['figure.facecolor'] = (18/256, 26/256, 34/256, 1)
mpl.rcParams['axes.facecolor'] = (18/256, 26/256, 34/256, 1)
mpl.rcParams['axes.edgecolor'] = (.9, .9, .9, 1)
mpl.rcParams['axes.labelcolor'] = (.9, .9, .9, 1)
mpl.rcParams['xtick.color'] = (.9, .9, .9, 1)
mpl.rcParams['ytick.color'] = (.9, .9, .9, 1)
...
ax1.plot(dataset_1[:, 0], 1e3*dataset_1[:, 3], linewidth=1, color=[1, 0.2, 0.2])
ax2.plot(dataset_2[:, 1], dataset_2[:, 4], linewidth=1, color=[1, .2, .2])
...
plt.savefig(here+'DoubleAxisDark.pdf')
plt.savefig(here+'DoubleAxisDark.png')
